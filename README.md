...
- [`docs/DEEP_DIVE_SCRIPT.md`](docs/DEEP_DIVE_SCRIPT.md) — the complete explanation: every module, hyperparameter, design decision and bug, in 15 chapters (Hinglish)
