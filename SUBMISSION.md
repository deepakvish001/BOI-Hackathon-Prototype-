...
| [`docs/DEEP_DIVE_SCRIPT.md`](docs/DEEP_DIVE_SCRIPT.md) | **complete deep dive** — 15 chapters covering every module, hyperparameter and design decision, plus the bugs we hit and how we found them |
